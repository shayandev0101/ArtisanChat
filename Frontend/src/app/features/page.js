      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            ویژگی‌های <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">منحصر به فرد</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="glass dark:glass-dark rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300"
            >
